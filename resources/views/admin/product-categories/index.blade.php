...
@section('content')
    <div class="mb-6 flex flex-wrap items-center justify-between gap-3">
        <p class="text-sm text-gray-600">{{ __('Only product-type categories appear in this list.') }}</p>
                ...
                <tbody class="divide-y divide-gray-100 text-gray-700">
                    @forelse ($categories as $category)
                        <tr class="hover:bg-cream/40">
                            ...
                            <td class="px-5 py-3"><span class="rounded-full bg-gold/15 px-2.5 py-0.5 text-xs font-semibold text-amber-900">{{ $category->type->label() }}</span></td>
