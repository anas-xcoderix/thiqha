<footer class="w-full bg-[#1D3256] bg-center bg-contain relative flex flex-col justify-between overflow-hidden"
        style="background-image: url('{{ asset ('img/images/footer/footerBG.png')}}');">
    <div class="px-4 pt-10">
        <div class=" mx-auto w-full flex flex-col lg:flex-row xl:justify-between gap-12 xl:gap-0 items-start">
            ...
            <div class="flex flex-col gap-8 w-full xl:w-auto">
                <a href="{{ route('home') }}">
                    <img src="{{ asset('img/images/footer/footer-logo.png') }}" alt="THIQAH Logo"
                         class="w-[240px] xl:w-[280px] 2xl:w-[380px] object-contain">
                </a>
            ...
            <div
                class="flex flex-col gap-4 xl:gap-[32px] text-white font-medium text-[18px] 2xl:text-[24px] min-w-[150px]">
                ...
                <a href="{{ route('ServiceProvider') }}" class="hover:text-gray-300 transition-colors">Service
                    Providers</a>
            ...
            <div
                class="flex flex-col gap-6 xl:gap-[32px] text-white text-[16px] xl:text-[18px] 2xl:text-[24px] max-w-[300px]">
                <div class="flex items-start gap-4">
                    <div class="xl:w-[16px] w-[12px] xl:h-[16px] mt-1 flex-shrink-0">
                        <img src="{{ asset('img/images/footer/location.png') }}" alt="Location"
            ...
            <div class="flex flex-col gap-6 xl:gap-[16px]">
                ...
                <div class="flex flex-col gap-[24px]">
                    <a href="#"
                       class="hover:opacity-80 transition-opacity w-[200px] xl:w-[269px] xl:h-[80px] 2xl:w-[320px] 2xl:h-[100px]">
        ...
        <div class="w-full py-6">
            <div
                class="main-container mx-auto border-t border-white pt-2 flex flex-col md:flex-row justify-between items-center gap-4 px-4 xl:px-0">
                ...
                <div class="flex gap-8 text-white text-[14px]">
                    ...
                    <a href="{{ route('terms-condition') }}" class="text-white underline font-bold">Terms &
                        Condition</a>
                </div>
            </div>
        </div>
