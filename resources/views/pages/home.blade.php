    ...
    <section class="bg-[#FAF8F4] main-container w-full mx-auto font-sans flex flex-col mt-16 px-4 md:px-6 xl:px-0">
        ...
        <div
            ...
            <div
                ...
                <div
                    class="absolute xl:h-[92px] xl:bottom-5 lg:bottom-4 bottom-3 xl:left-5 lg:left-4 left-3 xl:right-5 lg:right-4 right-3 bg-white xl:rounded-full lg:rounded-[22px] rounded-[20px] xl:px-6 lg:px-4 px-4 xl:py-4 lg:py-3 py-3 flex items-center justify-between shadow-[0_10px_25px_rgba(0,0,0,0.1)]">
                    <div class="flex flex-col overflow-hidden">
                        ...
                        <span
                            class="xl:text-[13px] lg:text-[11px] text-[11px] text-[#AAAAAA] font-medium xl:mb-1.5 lg:mb-1 mb-1">Building</span>
                        <div class="flex gap-1.5 xl:gap-2 flex-wrap">
                            <span
                                class="bg-[#D9D3E3] text-[#000000] xl:text-[10px] lg:text-[8px] text-[8px] xl:px-3 lg:px-2 px-2 xl:py-1 lg:py-0.5 py-0.5 rounded-full font-bold uppercase tracking-wider">Bricks</span>
                            <span
                                class="bg-[#D9D3E3] text-[#000000] xl:text-[10px] lg:text-[8px] text-[8px] xl:px-3 lg:px-2 px-2 xl:py-1 lg:py-0.5 py-0.5 rounded-full font-bold uppercase tracking-wider">Electrical</span>
                            <span
                                class="bg-[#D9D3E3] text-[#000000] xl:text-[10px] lg:text-[8px] text-[8px] xl:px-3 lg:px-2 px-2 xl:py-1 lg:py-0.5 py-0.5 rounded-full font-bold uppercase tracking-wider">Lighting</span>
                        </div>
                    </div>
                    <button
                        class="xl:w-10 xl:h-10 lg:w-8 lg:h-8 w-8 h-8 flex-shrink-0 flex items-center justify-center text-gray-400 hover:text-[#223862] transition-colors">
